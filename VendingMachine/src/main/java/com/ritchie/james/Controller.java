        ...
        while (running) {
            ...
            while (this.model.getState() == 1){
                ...
                if(input.equals("SELECT")){
                    ...
                    // Not sure if always should dispense change
            ...
            while(this.model.getState() == 3){
                this.view.printThreeStatePrompt(this.model.sellItem(inputToItemID(input)));
                if(this.model.getCurrentMoney() > 0){
                    this.model.setState(4);
                }else{
                    this.model.setState(0);
            ...
            while(this.model.getState() == 4){
                this.view.printFourStatePrompt(this.model.dispenseChange());
                this.model.setState(0);
            }
